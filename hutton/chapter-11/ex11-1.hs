...
-- This function finds the best move by evaluating the
-- game tree and selecting the move that leads to the
-- best outcome for the current player
...
-- computes the maximum depth of the game tree
treeDepth :: Tree a -> Int
treeDepth (Node _ ts) = 
  case ts of
    [] -> 0
